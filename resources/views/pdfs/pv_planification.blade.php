...
<head>
    ...
    <title>Procès Verbaux — {{ $filiere }} — {{ $section }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .admin-section { background: #FFD966; }
        .doctoral-section { background: #FFD966; }

        .student-list { height: 400px; }
        .signature-section { height: 150px; }

        .place-col { width: 8%; }
        .name-col  { width: 42%; }
        .signature-col { width: 50%; }
...
@foreach($pvPages as $index => $pv)
<div class="container {{ $index < count($pvPages) - 1 ? 'page-break' : '' }}" style="padding-right: 30px;">
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="value">{{ $pv['salle'] }}</td>
            <td class="label">Durée de l'épreuve :</td>
            <td class="value">
                @if($pv['heure_debut'] && $pv['heure_fin'])
                    {{-- calculate duration --}}
                @endif
            </td>
        </tr>
