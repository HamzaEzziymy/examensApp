...
import { Search, Plus, Upload, Download, Trash2, X, FileSpreadsheet, Users, ChevronLeft, ChevronRight, Eye } from 'lucide-react';
...
const Display = ({ 
  ...
  const inscriptionForm = useForm({
    ...
    id_niveau: '',
    id_section: '',
    date_inscription: new Date().toISOString().split('T')[0], // Today's date
    statut: 'Active',
